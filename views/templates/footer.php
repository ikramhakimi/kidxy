<div class="c-footer">
    <div class="o-container  u-padding-ends-xl">
        <div class="c-footer__secure-payments">
        ...
        <div class="o-grid  u-margin-top-lg">
            <div class="o-grid__item  u-width-1/3  u-width-1@mobile">
                ...
                <ul class="o-list">
                    ...
                    <li class="o-list__item"><a href="#">Privacy Policy</a></li>
                    <li class="o-list__item"><a href="#">Contact Us</a></li>
                    <li class="o-list__item"><a href="#">Blog</a></li>
                    <li class="o-list__item"><a href="#">Referal</a></li>
                </ul>
            </div>
            ...
            <div class="o-grid__item  u-width-1/3  u-width-1@mobile  u-margin-top-lg@mobile">
                ...
                <ul class="o-list">
                    ...
                    <li class="o-list__item"><a href="#">Partner List</a></li>
                </ul>
            </div>
